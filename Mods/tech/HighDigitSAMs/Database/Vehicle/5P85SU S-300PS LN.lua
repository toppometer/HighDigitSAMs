...
GT.WS[ws].LN[1].depends_on_unit = {{{"S-300PS SA-10B 40B6M MAST tr"},},{{"S-300PS 30N6 TRAILER tr"},},};
...
GT.Name = "S-300PS 5P85SU_mod ln";
GT.DisplayName = _('SAM SA-10B S-300PS "Grumble" TEL U');
